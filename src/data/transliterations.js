...
export function getCandidatesFor(syllable, seedOffset = 0) {
    if (BY_SYLLABLE[syllable])
        return BY_SYLLABLE[syllable].map((c, i) => ({ ...c, seed: c.seed + seedOffset + i }));
...
export function getFunExtrasFor(syllable, seedOffset = 0) {
...
export const SCRIPT_CULTURE_KO = {
    latin: '영어',
    hanja: '한자',
    katakana: '일본',
    hiragana: '일본',
